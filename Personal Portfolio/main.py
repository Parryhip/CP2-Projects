...
from final_project_term1 import *
    ...
    def descriptions():
        while True:
            ...
            try:
                ...
                descriptionchoice = input("Type the number by the project that you want to view the description for(or type exit to exit).\n-->")
                
                #if the user is trying to exit, do so
                if descriptionchoice == "exit":
                    return
                
                #testing if the input is a number
                test = int(descriptionchoice)

            #if the user doesn't type a number (integer)
            except:
                #tell them their input is invalid
                print("Not a number!")
    ...
    def programs():
        while True:
            ...
            try:
                ...
                choice = input("Type the number by the project that you want to run(or type exit to exit).\n-->")
